...
def load_state(net, optimizer, scheduler, args, load_best=False):
    ...
    base_path = "./data/"
    amp_checkpoint = None
    checkpoint_path = os.path.join(base_path,"task_test_checkpoint_BERT.pth.tar")
    best_path = os.path.join(base_path,"task_test_model_best_BERT.pth.tar")
...
def load_results():
    ...
    losses_path = "./data/task_test_losses_per_epoch_BERT.pkl"
    accuracy_path = "./data/task_train_accuracy_per_epoch_BERT.pkl"
    f1_path = "./data/task_test_f1_per_epoch_BERT.pkl"
    if os.path.isfile(losses_path) and os.path.isfile(accuracy_path) and os.path.isfile(f1_path):
        losses_per_epoch = load_pickle("task_test_losses_per_epoch_BERT.pkl")
        accuracy_per_epoch = load_pickle("task_train_accuracy_per_epoch_BERT.pkl")
        f1_per_epoch = load_pickle("task_test_f1_per_epoch_BERT.pkl")
